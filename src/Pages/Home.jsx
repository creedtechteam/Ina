...
function Home() {
  ...
  return (
    <>
      ...
      <section
        ref={exploreRef}
        className={`w-full min-h-[60vh] flex items-center justify-center bg-pink-100 py-8 px-4 md:px-0 ${sectionClass}`}
        data-aos="fade-up"
      >
      ...
      {/* About INA Section */}
      <section
        className={`w-full bg-pink-100 mt-10 py-10 px-4 flex justify-center ${sectionClass}`}
        data-aos="fade-up"
      >
      ...
      <section
        ref={howRef}
        className={`w-[100%] min-h-auto bg-[url('/bg-low.png')] bg-center-[4rem] bg-cover bg-no-repeat lg:h-[600px] mt-10 py-12 px-4 flex justify-center items-center overflow-hidden ${sectionClass}`}
        data-aos="fade-up"
      >
        {/* relative*/}
      ...
      <section
        ref={empowerRef}
        className={`w-full bg-pink-100 py-12 px-4 flex items-center justify-center mt-10 ${sectionClass}`}
        data-aos="fade-up"
      >
      ...
      <section
        className="w-full bg-gray-200 mt-10 py-10 px-4 flex flex-col items-center"
        data-aos="fade-up"
      >
        <h2 className="text-xl md:text-2xl font-semibold text-gray-700 mb-8 text-center">
          Transform Emotions Into Digital Legacy.
        </h2>
      ...
      <section
        className="bg-pink-50 mt-10 py-10 px-4 flex flex-col items-center justify-center w-full"
        data-aos="fade-up"
      >
        <h2 className="text-xl md:text-2xl font-semibold text-gray-700 mb-4 text-center">
          join the sisterhood today
        </h2>
        <p className="text-gray-700 text-base md:text-lg mb-6 text-center max-w-2xl">
          Embrace your journey and connect with a community that understands and
          supports you.
        </p>
