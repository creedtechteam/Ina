      ...
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-start gap-10">
        ...
        <div className="flex flex-col gap-2 min-w-[220px]">
          ...
          <span className="text-sm text-gray-200">
            Subscribe now for exclusive insight job and deals!
          </span>
          <form className="flex mt-2">
            <input
              type="email"
              placeholder="Enter your email"
              className="rounded-l-md px-4 py-2 text-gray-800 focus:outline-none w-full max-w-[160px]"
            />
            <button
              type="submit"
              className="bg-pink-300 hover:bg-pink-400 text-white font-semibold px-4 py-2 rounded-r-md transition"
            >
              Subscribe
            </button>
          </form>
