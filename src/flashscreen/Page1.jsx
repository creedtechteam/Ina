...
import pagelo from "../assets/WhatsApp Image 2025-07-02 at 14.41.34_fc51ac99 1.png"; // Placeholder for logo image
const Page1 = () => {
...
// This code defines a React component for the first page of a splash screen.
// It includes animated background particles, floating gradient orbs, and a main content section with a logo, heading, subtitle, and a button with an arrow icon.
